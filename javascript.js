...
let weather = {
  ...
  displayWeather: function (data, DayNumber) {
    ...
    const speed4 =
      Math.round(Number(data.list[23].wind.speed) * 3.6 * 100) / 100;
    ...
    function modify(day, arr, icon, temp, desc, pop, humidity, speed) {
      ...
      document.querySelector(
        ".Date"
      ).innerText = `${arr[0]} ${arr[1]} ${arr[2]}`;
      document.querySelector(".Card-1 .part2 img").src =
    ...
    function CardBackground(main) {
      ...
      if (main == "Rain") {
        ...
        style.setProperty(
          "--background",
          "url('https://source.unsplash.com/1600x900/?Clouds')"
        );
      } else if (main == "Clear") {
        style.setProperty(
          "--background",
    ...
    document.querySelector(".One img").src =
    ...
    document.querySelector(".Two img").src =
    ...
    document.querySelector(".Three img").src =
    ...
    document.querySelector(".Four img").src =
...
document.querySelector(".One").addEventListener("click", function () {
  weather.displayWeather(D, 1);
});
document.querySelector(".Two").addEventListener("click", function () {
  weather.displayWeather(D, 2);
});
document.querySelector(".Three").addEventListener("click", function () {
  weather.displayWeather(D, 3);
});
document.querySelector(".Four").addEventListener("click", function () {
  weather.displayWeather(D, 4);
});
